...
class ViewAdapterListSearchJob(var ds:List<DataView>, val onClick:RvInterface): RecyclerView.Adapter<ViewAdapterListSearchJob.Detail>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Detail {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.layout_list_search_job,parent,false)
        return  Detail(view)
    }
